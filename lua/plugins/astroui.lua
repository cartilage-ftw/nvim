  ...
  opts = {
    ...
    highlights = {
      ...
      astrotheme = { -- a table of overrides/changes when applying the astrotheme theme
        ...
        ["@variable.parameter.python"] = { fg = "#abb2bf" },
        ...
        ["@variable.member.python"] = { fg = "#abb2bf" },
        -- C
